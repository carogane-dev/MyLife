...
// Représente une ligne NutritionModeConfig chargée depuis le backend (voir
// useNutritionConfig.ts) — ces valeurs vivent en base plutôt qu'en
// constantes ici pour être ajustables sans déploiement de code.
